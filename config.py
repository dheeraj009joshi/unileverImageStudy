...
class Config:
    ...
    # Contact Information
    CONTACT_INFO = {
        'address': os.environ.get('CONTACT_ADDRESS', 'Unilever House, 100 Victoria Embankment, London EC4Y 0DY, United Kingdom'),
        'phone': os.environ.get('CONTACT_PHONE', '+44 20 7822 5252'),

...
def main():
    ...
    print("   Access the application at: http://localhost:51000")
    print("   Dashboard: http://localhost:51000/dashboard")
    print("   Study Creation: http://localhost:51000/study/create")
